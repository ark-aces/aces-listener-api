...
/**
* Default service.
* @module arkaces-encoded-listener-client/DefaultApi
* @version 0.1.0
*/
export default class DefaultApi {
    ...
    * @alias module:arkaces-encoded-listener-client/DefaultApi
    * @class
    ...
    */
     ...
     * @callback module:arkaces-encoded-listener-client/DefaultApi~statusGetCallback
     ...
     * @param {module:arkaces-encoded-listener-client/DefaultApi~statusGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:arkaces-encoded-listener-client/DefaultApi~subscriptionsIdEventsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:arkaces-encoded-listener-client/DefaultApi~subscriptionsIdEventsGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:arkaces-encoded-listener-client/DefaultApi~subscriptionsIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} id Subscription Identifier
     * @param {module:arkaces-encoded-listener-client/DefaultApi~subscriptionsIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:arkaces-encoded-listener-client/DefaultApi~subscriptionsIdUnsubscribesPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} id Subscription Identifier
     * @param {module:arkaces-encoded-listener-client/DefaultApi~subscriptionsIdUnsubscribesPostCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:arkaces-encoded-listener-client/DefaultApi~subscriptionsPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Subscription} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:arkaces-encoded-listener-client/DefaultApi~subscriptionsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Subscription}
     */
