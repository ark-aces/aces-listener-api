...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AcesEncodedListenerApi.NotFoundError();
  });
  ...
  describe('NotFoundError', function() {
    it('should create an instance of NotFoundError', function() {
      ...
      //var instane = new AcesEncodedListenerApi.NotFoundError();
      //expect(instance).to.be.a(AcesEncodedListenerApi.NotFoundError);
    });
