...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AcesEncodedListenerApi.FieldError();
  });
  ...
  describe('FieldError', function() {
    it('should create an instance of FieldError', function() {
      // uncomment below and update the code to test FieldError
      //var instane = new AcesEncodedListenerApi.FieldError();
      //expect(instance).to.be.a(AcesEncodedListenerApi.FieldError);
    });
